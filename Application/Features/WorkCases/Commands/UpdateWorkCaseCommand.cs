...
{
    public record UpdateWorkCaseCommand(decimal Amount, string Relation, Guid ForwarderId, Guid ClientId, Guid WorkCaseId) : IRequest<AppResult<Unit>>;
    public class EditWorkCaseHandler(FormupContext context) : IRequestHandler<UpdateWorkCaseCommand, AppResult<Unit>>
    {
