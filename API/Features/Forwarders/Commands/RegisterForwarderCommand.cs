...
namespace Application.Features.Forwarders.Commands
{
    ...
    public class RegisterForwarderHandler : IRequestHandler<RegisterForwarderCommand, UserResponseDTO>
    {
        private readonly FormupContext _context;
        private readonly ITokenService _tokenService;

        public RegisterForwarderHandler(FormupContext context, ITokenService tokenService)
        {
            _context = context;
